...
public class Player : MonoBehaviour
{
    ...
    [SerializeField]
    private AudioSource hurt_die_audiosrc;
    ...
    public void Hurt(float level)
    {
        if (gamemode != "Creative" && !died)
        {
            ...
            {
                hurt_die_audiosrc.PlayOneShot(hurt_sound);
			}
		}
    }
	...
	public void GameOver()
    {
        hud.SetActive(false);
        Time.timeScale = 0f;
        hurt_die_audiosrc.PlayOneShot(die_sound);
